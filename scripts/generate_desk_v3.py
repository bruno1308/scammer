#!/usr/bin/env python3
"""
Regenerate foreground desk v3 — simple, clean desk with minimal clutter.

Usage: python scripts/generate_desk_v3.py
"""
...
NEGATIVE = (
    ...
    "stapler, donut, food, monitor, computer, phone, keyboard"
)
MAGENTA_BG = "on solid bright magenta pink FF00FF background"

prompt = (
    f"Simple worn office desk, {CAMERA}, "
    "scratched beige laminate desktop surface with front edge visible, "
    "a pen cup with pens on the far left side, "
    "two small sticky notes on the left, one coffee ring stain near center left, "
    "mostly bare clean desk surface across center and right, "
    "slightly dirty and stained from years of use, "
    "simple wooden desk frame, the desk is almost empty, "
    f"{OFFICE_STYLE}, {MAGENTA_BG}. {NEGATIVE}"
)

print("=" * 60)
print("  Generating clean desk v3")
print("=" * 60)
